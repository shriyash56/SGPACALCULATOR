...
public class Sem1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sPhy = (Spinner) findViewById(R.id.spinnerPhysics);
        sM1 = (Spinner) findViewById(R.id.spinnerM1);
        sBEE = (Spinner) findViewById(R.id.spinnerBEE);
        sEG = (Spinner) findViewById(R.id.spinnerEG);
        sEM = (Spinner) findViewById(R.id.spinnerEM);
        sEE = (Spinner) findViewById(R.id.spinnerEE);
        tvSgpa = (TextView) findViewById(R.id.tVSGPA);
        bcalculate = (Button) findViewById(R.id.buttonCalculate);



        ArrayAdapter<String> adapter = new ArrayAdapter<>(Sem1Activity.this, android.R.layout.simple_list_item_1, sValue);
